...
class ResetPassVerification extends StatefulWidget {
  const ResetPassVerification({super.key, required this.email});
  final String email;

  @override
  State<ResetPassVerification> createState() => _ResetPassVerificationState();
}

class _ResetPassVerificationState extends State<ResetPassVerification> {
